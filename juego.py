...
fondo = pygame.image.load("fondo2u2.png")
...
while running:
    ...
    for square in squares:
        ...
        if square[0] + 15 > constantes.ANCHURA_PANTALLA or square[0] < 0:
            square[2] *= -1
        imagen2 = pygame.image.load("pesesito.png")
    ...
    tiempo_texto = font.render(f"Tiempo: {tiempo_restante / 60:.0f}:{tiempo_restante % 60:.0f}", True, (255, 255, 255))
    screen.blit(tiempo_texto, (590, 40))

    # Mostrar la cantidad de cuadrados agarrados
    cuadrados_texto = font.render(f"Peces: {cuadrados_agarrados}", True,  (255, 255, 255))
    screen.blit(cuadrados_texto, (590, 70))

    cuadrados_texto = font.render(f"Basura: {circulos_agarrados}", True,  (255, 255, 255))
    screen.blit(cuadrados_texto, (590, 100))
